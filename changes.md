...
Изменения 8.04.2022
1. Переписал тестирование с изображениями
2. Написал функции (в python) и классы для отрисовки графиков коллизий при хешировании изображений и скорости хешей
3. Написал специализацию ThreadTasks и сделал запуск тредов в нем для тестов на распределение

Изменения 17.04.2022
1. Написал функции и класс (в python) для отрисовки графиков лавинного эффекта

Изменения 18.04.2022
1. Удалил LibJPEG и связанные с ним файлы
2. Удалил хеширование изображений
3. Сделал seed во всех хеш-функциях теперь случайным и добавил хеш-функции со случайным seed'ом
   
Изменения 19.04.2022
1. Переименовал HashStruct в Hash и сделал небольшой рефакторинг кода основанного на нем
2. Сделал тестирования коллизий со случайными "словами" многопоточным (но в будущем требуется рефакторинг)

Изменения 25.04.2022
1. Переработал класс TestParameters и его производные
2. Переработал класс Hash. Теперь он содержит указатель на хэш-функцию, а не ссылку

Изменения 26.04.2022
1. Провел большой рефакторинг кода
2. Переработал класс PearsonHash24 и создал класс PearsonHash48
3. Сделал подсчет медианного расстояния Хемминга

Изменения 02.05.2022
1. Провел рефакторинг кода python

Изменения 03.05.2022 - 20.06.2022
1. Рефакторинг кода
2. Добавил отрисовку общей диаграммы (карты) хешей
3. Отредактивовал readme.md, добавив инструкцию по запуску